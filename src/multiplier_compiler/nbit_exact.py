                    ...
                    for add_idx in range(adder_count):
                        ...
                        if is_low_part:
                            ...
                            if adder_type == "e42_special_n" and adder == "E_4_2":
                                ...
                                e42_signal = "pp1_{}_special_e42_s".format(col)
                                e42_carry = "pp1_{}_special_e42_c".format(col)
                                e42_cout = "pp1_{}_special_e42_cout".format(col)
                                ...
                                assignments.append("    E_4_2 special_e42_{}_{}(".format(col, add_idx))
                                ...
                                assignments.append("    Half_adder ha_{}_{}(".format(col, add_idx))
                                assignments.append("        .a({}),".format(pp_terms_for_compression[0]))
                                assignments.append("        .b({}),".format(pp_terms_for_compression[1] if len(pp_terms_for_compression) > 1 else "1'b0"))
                                assignments.append("        .S({}),".format(ha_signal))
                                assignments.append("        .C({})".format(ha_carry))
                                assignments.append("    );")
            ...
            if col == special_col1 and not is_low_part:
                ...
                if total_pp_terms <= output_width:
                    ...
                    if is_low_part:
                        ...
                        compressor_count, adder_count, adder_type = self._calculate_intermediate_stage_compressor_counts(
                    ...
                    for add_idx in range(adder_count):
                        ...
                        if is_low_part:
                            ...
                            if adder_type == "e42_special_n" and adder == "E_4_2":
                                ...
                                e42_signal = "pp{}_{}_special_e42_s".format(output_stage, col, add_idx)
                                e42_carry = "pp{}_{}_special_e42_c".format(output_stage, col, add_idx)
                                e42_cout = "pp{}_{}_special_e42_cout".format(output_stage, col, add_idx)
                                ...
                                assignments.append("    E_4_2 special_e42_{}_{}_{}(".format(output_stage, col, add_idx))
                                assignments.append("        .a({}),".format(e42_inputs[0]))
                                assignments.append("        .b({}),".format(e42_inputs[1]))
                                assignments.append("        .c({}),".format(e42_inputs[2]))
                                assignments.append("        .d(cin_net),")  
