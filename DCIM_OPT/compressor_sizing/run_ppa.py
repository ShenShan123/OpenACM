    ...
    try:
        ...
        patterns = [
            ...
            (r'Performance\s*\(?\s*delay\s*\)?\s*:?\s*([\d.eE+-]+)', 
             ...
             r'Area\s*\(?\s*with\s+7\s*\S?\s+overhead\s*\)?\s*:?\s*([\d.eE+-]+)'),
...
def main():
    ...
    widths = [
        2.700000, 1.270000,  # NOR2_X1: nmos_0.415, pmos_0.63
        0.190000, 2.665000,  # NAND2_X1: nmos_0.415, pmos_0.63
        1.675000, 2.035000, 0.235000, 1.675000,  # XOR2_X1: nmos_0.21, nmos_0.415, pmos_0.315, pmos_0.63
        1.360000, 2.080000, 0.460000, 0.865000,  # XNOR2_X1: nmos_0.21, nmos_0.415, pmos_0.315, pmos_0.63
        2.440000, 2.170000,  # OAI21_X1: nmos_0.415, pmos_0.63
    ]
